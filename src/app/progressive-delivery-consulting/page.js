...
<div className='my-5 py-1'></div>
                ...
                <div className="container">
                    <div className=" row  ">
                        ...
                        <div className="col-md-6 col-12 ">
                            <img
                                src="https://www.infracloud.io/assets/img/progressive-delivery-consulting/progressive-hero.svg"
                                alt="Logo"
                                className="img-fluid"
                            />
                        </div>
                ...
                <div className=" container p-3">
                    <div className="">
                        ...
                        <div className=" text-center p-3">
                            <h2 className="fw-bold">Benefits of Progressive Delivery Consulting Services</h2>
                        </div>
            ...
            <div className="top-to-bottom-color">
                <div className="container p-5">
                    ...
                    <div className="text-center mt-5">
                        <h2 className="fw-bold">What do we offer in Progressive Delivery Consulting?</h2>
                        <p className="text-gray">Our consultants & engineers help you to make the most of progressive delivery to optimize your delivery cycles.</p>
                    </div>
            ...
            <div className="top-to-bottom-color p-5">
                <div className=" container mt-5 mb-5">
                    ...
                    <div className=" text-center mt-5">
                        <h2 className="mb-3 fw-bold">Why InfraCloud for Progressive Delivery Consulting Services?</h2>
            ...
            <div className=" mb-5 p-5 top-to-bottom-color">
                <div className=" container">
                    <div className="text-center p-4">
                        <h3 className="fw-bold">Got a question around Progressive Delivery Consulting?</h3>
                    </div>
