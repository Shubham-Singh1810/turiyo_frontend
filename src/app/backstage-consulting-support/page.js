                ...
                <div className="container">
                    <div className=" row  ">
                        ...
                        <div className="mt-5 col-md-6 col-12 ">
                            <h2 className="mb-3 fw-bold">Backstage Consulting &
                                Enterprise Support</h2>
                            <p className="mb-4 text-gray medium-text">Internal developer platform (IDP) experts building a tailored Backstage solution that improves developers’ productivity - for orgs of all sizes.</p>
                            <button className="btn px-4 py-2 " style={{ background: "#C0202E", borderRadius: "15px", border: "none" }}>Talk to a Backstage Expert</button>
            ...
            <div className="top-to-bottom-color">
                <div className="container p-5">
                    ...
                    <div className="text-center mt-5">
                        ...
                        <p className="text-gray">Leverage our Backstage consulting expertise to help you adopt, implement, and manage Backstage at scale.</p>
                    </div>
            ...
            <div className=" top-to-bottom-color">
                <div className=" container p-4 text-center mt-3 mb-3">
                    <div className=" mt-5 mb-5">
                        ...
                        {/* Button */}
                        <button className="btn px-4 py-2 " style={{ background: "#C0202E", borderRadius: "15px", border: "none" }}>Talk to Backstage Expert</button>
