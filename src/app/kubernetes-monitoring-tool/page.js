        ...
        <>
                ...
                <div className="container">
                    <div className=" row  ">
                        ...
                        <div className="mt-5 col-md-5 col-12 ">
                            <h2 className="mb-3 fw-bold">Kubernetes Monitoring <br></br>Made Simple</h2>
            ...
            <div className="mt-5 mb-5">
                <div className="mt-5 mb-5 p-5 border border-primary container bg-purple text-center" style={{ borderRadius: "12px" }}>
                    ...
                    <button className="btn px-5 py-2 m-4" style={{ background: "#C0202E", borderRadius: "15px", border: "none" }}>Add to Slack</button>
                    <button className="btn px-5 py-2 " style={{ background: "#C0202E", borderRadius: "15px", border: "none" }}>Add to Items</button>
